...
sound = pygame.mixer.Sound("/peo-ddeug/WakeUpGame/mp3/BGM2.mp3")
...
def runGame():
    ...
    bug_image = pygame.image.load('/peo-ddeug/WakeUpGame/img/sprite1.png')
    ...
    while not done:
        ...
        remain_time_image = small_font.render(
            'Time {}'.format(remain_time), True, YELLOW)
